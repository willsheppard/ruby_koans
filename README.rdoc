= NOTE: This is a temporary development area for me personally to learn Ruby

This repo has commits in the master branch representing the progress I made
completing the koans. If you want to figure out the koans by yourself,
go and check out the original repo at https://github.com/neall/ruby_koans
