...
class AboutRegularExpressions < Neo::Koan
  ...
  # Why?
  #
  # Because they match as much as they can.
  ...
  # 
  # Character class matches any character in the list.
  # Alternation matches any string in the list.
  ...
  def test_gsub_is_like_find_and_replace_all
    ...
    assert_equal "one o-e", "one two-three".gsub(/(t\w*)/) { $1[-1, 1] }
  end
end
