...
class AboutScope < Neo::Koan
  ...
  def test_you_can_reference_nested_classes_using_the_scope_operator
    ...
    assert_equal AboutScope::Jims::Dog, fido.class
    assert_equal AboutScope::Joes::Dog, rover.class
  ...
  def test_bare_bones_class_names_assume_the_current_scope
    ...
    assert_equal true, AboutScope::Ping == Ping
  end

  def test_nested_string_is_not_the_same_as_the_system_string
    assert_equal false,             String == "HI".class
    assert_equal false, AboutScope::String == "HI".class
    assert_equal "String", "HI".class.to_s # the system String class
  end
  ...
  def test_you_can_get_a_list_of_constants_for_any_class_or_module
    ...
    #assert_equal 113, Object.constants.size
    # ^ number of constants increases, the more code you load
  end
end
